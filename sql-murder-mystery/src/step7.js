...
class Step7 extends React.Component{
  constructor (props) {
    super(props);
		...
		this.state = {batch1Correct: false, batch2Correct: false, user_id: '', password: '',
  ...
  render(){
		...
		if(this.state.suspectCorrect){
			injection2 = <Container>
				...
				<LoginSQL game_step = 'S7_B2' batchSqlCorrect={this.handleBatch2Success} congratsMessage = "Congratulations, your SQL Injection was successful! Here are the results of your query:" failureMessage = "Hmm it doesn't look like your Injection Query was successful. Please try again."></LoginSQL>
			</Container>;
		}
		...
		if (this.state.loginClicked && !this.state.isLoginSuccessful){
			...
			queryResponse = <div className="instruction-div">
			<p> 
				ADD MODAL FOR THIS: Congratulations, you solved the mystery! 
			</p>
		</div>;
		}
		let login = null;
    ...
    return(
			<Container fluid="md">
				...
				<LoginSQL game_step = 'S7_B1' batchSqlCorrect={this.handleBatch1Success} congratsMessage = "Congratulations, your SQL Injection was successful! Here are the results of your query:" failureMessage = "Hmm it doesn't look like your Injection Query was successful. Please try again."></LoginSQL>
				{suspect}
				{injection2}
				{login}
